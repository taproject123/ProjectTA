...
<html>
    ...
    <body>
            ...
            <div class="subnavbar-inner">
                <div class="container">
                    <ul class="mainnav">
                        ...
                        <li class="active"><a href="view_weeklyQuiz.htm"><i class="icon-edit"></i><span>Weekly Quiz</span> </a> </li>
        ...
        <p><a href="form_tambah_weeklyQuiz.htm">Tambah Weekly Quiz</a></p>
        <!-- /widget -->
        <div class="widget widget-table action-table">
            ...
            <div class="widget-content">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <c:forEach var="data" items="${listWeeklyQuiz}">
                            <c:url var="delete" value="delete_weeklyQuiz.htm">
                                <c:param name="id" value="${data.id}"/>
                            </c:url>
                            <c:url var="update" value="form_ubah_weeklyQuiz.htm">
                                <c:param name="id" value="${data.id}"/>
                            </c:url>
                            <tr>
                                <td>${data.id}</td>
                                <td>${data.weekly_quiz}</td>
                                <td>${data.answer}</td>
                                <td>${data.timeopen}</td>
